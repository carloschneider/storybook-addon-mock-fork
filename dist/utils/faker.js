  ...
  constructor() {
    ...
    _defineProperty(this, "matchMock", function (url) {
      ...
      for (var key in _this.requestMap) {
        ...
        var requestPath = _this.getPath(requestUrl);

        if ((0, _pathToRegexp.match)(requestPath)(path) && method == requestMethod && !_this.requestMap[key].skip) {
